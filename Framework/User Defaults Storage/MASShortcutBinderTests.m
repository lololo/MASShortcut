...
- (void) testInitialValueReading
{
    ...
    [_defaults setObject:[NSKeyedArchiver archivedDataWithRootObject:shortcut requiringSecureCoding:true error:NULL] forKey:SampleDefaultsKey];
...
- (void) testValueChangeReading
{
    MASShortcut *shortcut = [MASShortcut shortcutWithKeyCode:1 modifierFlags:1];
    [_binder bindShortcutWithDefaultsKey:SampleDefaultsKey toAction:^{}];
    [_defaults setObject:[NSKeyedArchiver archivedDataWithRootObject:shortcut requiringSecureCoding:true error:nil] forKey:SampleDefaultsKey];
    XCTAssertTrue([_monitor isShortcutRegistered:shortcut],
